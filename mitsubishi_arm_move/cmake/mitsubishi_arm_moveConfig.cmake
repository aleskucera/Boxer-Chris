...
if("FALSE" STREQUAL "TRUE")
  set(mitsubishi_arm_move_SOURCE_PREFIX /opt/salt-install/b3b33rob_ws/src/mitshubishi_arm/mitsubishi_arm_move)
  set(mitsubishi_arm_move_DEVEL_PREFIX /opt/salt-install/b3b33rob_ws/devel/.private/mitsubishi_arm_move)
  ...
  set(mitsubishi_arm_move_INSTALL_PREFIX /opt/ros/b3b33rob)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'kuri <kuri@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'mitsubishi_arm_move' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'mitsubishi_arm_move' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT mitsubishi_arm_move_NUM_DUMMY_TARGETS)
      set(mitsubishi_arm_move_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::mitsubishi_arm_move::wrapped-linker-option${mitsubishi_arm_move_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR mitsubishi_arm_move_NUM_DUMMY_TARGETS "${mitsubishi_arm_move_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::mitsubishi_arm_move::wrapped-linker-option${mitsubishi_arm_move_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND mitsubishi_arm_move_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${mitsubishi_arm_move_dep}_FOUND)
      find_package(${mitsubishi_arm_move_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${mitsubishi_arm_move_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
